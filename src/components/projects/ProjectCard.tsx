...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      {/* ── Main card body ── */}
      <div className="relative bg-[#ff5500] group-hover:bg-[#050505] border-[2px] border-black group-hover:border-[#ff5500] p-6 sm:p-10 lg:p-14 transition-all duration-500 overflow-hidden shadow-[12px_12px_0px_rgba(0,0,0,1)] group-hover:shadow-[0_0_15px_rgba(255,85,0,0.3)] hover:-translate-y-2">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-between items-center mb-8 lg:mb-12">
            <div className="border border-black group-hover:border-[#ff5500] px-4 py-1.5 flex items-center gap-4 bg-black/10 group-hover:bg-[#ff5500]/10 backdrop-blur-sm transition-colors duration-500">
              <span className="font-mono text-[10px] sm:text-xs tracking-[0.3em] text-black group-hover:text-[#ff5500] uppercase font-bold transition-colors duration-500">
          ...
          <div className="mb-10 lg:mb-16">
            <h3 className="font-display text-5xl sm:text-6xl lg:text-7xl font-black text-black group-hover:text-[#ff5500] uppercase tracking-tight leading-[0.9] mb-6 lg:mb-8 group-hover:drop-shadow-[0_0_15px_rgba(255,85,0,0.4)] drop-shadow-none transition-all duration-500">
              {project.title}
            </h3>
            ...
            <p className="font-mono text-sm sm:text-base text-neutral-900 group-hover:text-neutral-300 leading-relaxed max-w-3xl border-l-2 border-black group-hover:border-[#ff5500]/50 pl-4 lg:pl-6 bg-gradient-to-r from-black/10 group-hover:from-[#ff5500]/5 to-transparent py-2 transition-colors duration-500 font-medium">
              {project.description}
            </p>
          </div>
          ...
          <div className="mb-10 lg:mb-12">
            <div className="flex items-center gap-4 mb-6">
              <h4 className="font-mono text-xs sm:text-sm text-black group-hover:text-[#ff5500] font-bold tracking-[0.2em] uppercase transition-colors duration-500">
                TECH STACK
              </h4>
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              {project.tags.map((tag) => {
                ...
                return (
                  <span
                    key={tag}
                    className="flex items-center gap-2 font-mono text-[10px] sm:text-xs tracking-[0.1em] text-black group-hover:text-[#ff5500] border border-black group-hover:border-[#ff5500] px-4 py-2 uppercase font-semibold bg-transparent group-hover:bg-black/50 hover:!bg-[#ff5500] hover:!text-black transition-colors duration-300 backdrop-blur-sm"
                  >
                    {getIcon()}
                    {tag}
                  </span>
            ...
            <div className="flex gap-4">
              {project.github && (
                <a
                  ...
                  className="inline-flex items-center gap-3 border-[2px] border-black group-hover:border-[#ff5500] text-black group-hover:text-[#ff5500] px-6 py-3 font-mono text-xs tracking-[0.2em] font-bold uppercase hover:!bg-[#ff5500] hover:!text-black transition-all duration-300 group/btn"
                >
              ...
              {project.live && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-black group-hover:bg-transparent border-[2px] border-black group-hover:border-[#ff5500] text-[#ff5500] group-hover:text-[#ff5500] px-6 py-3 font-mono text-xs tracking-[0.2em] font-bold uppercase hover:!bg-[#ff5500] hover:!text-black hover:!border-[#ff5500] transition-all duration-300 group/btn"
                >
                  LIVE DEMO
                  <ArrowUpRight className="w-4 h-4 opacity-50 group-hover/btn:opacity-100 transition-opacity" />
                </a>
